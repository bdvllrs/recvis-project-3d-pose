...
dataset = Human36M('../dataset/h36m/', max_video_length=config.max_video_length,
                   video_constraints=config.video_constraints.use,
                   frames_before=config.video_constraints.frames_before, frames_after=config.video_constraints.frames_after)
...
number_frames = config.video_constraints.frames_before + config.video_constraints.frames_after + 1
...
trainer = Trainer(train_set, test_set, optimizer, model, dataset,
                  ...
                  video_constraints=config.video_constraints.use,
                  frames_before=config.video_constraints.frames_before,
                  frames_after=config.video_constraints.frames_after,
                  regularization_video_constraints=config.video_constraints.regularization).to(device)
